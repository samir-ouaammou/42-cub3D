...
void	ft_check_path_to_the_north_texture_is_valid(t_parsing *data)
{
	...
	data->data->no_texture = mlx_xpm_file_to_image(data->data->mlx, data->split[1], &width, &height);
...
void	ft_check_path_to_the_south_texture_is_valid(t_parsing *data)
{
	...
	data->data->so_texture = mlx_xpm_file_to_image(data->data->mlx, data->split[1], &width, &height);
...
void	ft_check_path_to_the_west_texture_is_valid(t_parsing *data)
{
	...
	data->data->we_texture = mlx_xpm_file_to_image(data->data->mlx, data->split[1], &width, &height);
...
void	ft_check_path_to_the_east_texture_is_valid(t_parsing *data)
{
	...
	data->data->ea_texture = mlx_xpm_file_to_image(data->data->mlx, data->split[1], &width, &height);
